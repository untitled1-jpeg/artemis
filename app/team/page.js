            ...
            <section className="team-list" style={{ padding: '4rem 0', backgroundColor: 'var(--color-teal)' }}>
                <div className="container" style={{ maxWidth: '1200px' }}>
                    ...
                    <TeamMember
                        ...
                        bio={`Lulu Herrick is a Director at Artemis. She supports Artemis in all facets of the business from underwriting to client service. A recent graduate with a degree in Statistics from Southern Methodist University, Lulu brings a fresh analytical perspective to her work.\n\nIn her role, she collaborates closely with carriers to ensure smooth and accurate policy placement, while also assisting with day-to-day client needs and operations. Lulu holds her General Lines Life and Health license.\n\nOutside of the office, Lulu enjoys traveling with her family and cooking with friends. She is excited to continue learning and growing within the industry.`}
                        summary={`Lulu Herrick is a Director at Artemis. She supports Artemis in all facets of the business from underwriting to client service. A recent graduate with a degree in Statistics from Southern Methodist University, Lulu brings a fresh analytical perspective to her work.\n\nIn her role, she collaborates closely with carriers to ensure smooth and accurate policy placement, while also assisting with day-to-day client needs and operations. Lulu holds her General Lines Life and Health license.\n\nOutside of the office, Lulu enjoys traveling with her family and cooking with friends. She is excited to continue learning and growing within the industry.`}
