...
export default function Team() {
    ...
    return (
        <main ref={contentRef} style={{ backgroundColor: 'var(--color-teal)' }}>
            ...
            <PageHero
                title={"THE ARTEMIS\nTEAM"}
                image="/images/img_team-header.jpg"
                bgPos="top center"
            ...
            <section className="team-list" style={{ padding: '4rem 0', backgroundColor: 'var(--color-teal)' }}>
                <div className="container" style={{ maxWidth: '1200px' }}>
                    ...
                    <TeamMember
                        ...
                        image="/images/img_bianca.jpg"
                        bio={`Bianca Admire is a Principal at Artemis, participating in client service and firm operations. With over a decade of client service experience and in the financial services industry, Bianca takes pride in providing prompt responses and maintaining long-term relationships with Artemis clients.\n\nShe started her career at UBS Wealth Management and through an Ursuline alumni connection was fortunate to make the leap to an independent life insurance group that later merged with a local RIA. While there she obtained her CFP® and CLU. She is FINRA licensed with her series 7 and 66 and has her General Lines Life and Health license in Texas.\n\nBianca is a graduate of Texas Christian University. She is part of the Board of Governors for the Dallas Estate Planning Council and on the Professional Advisory Council with the Dallas Foundation.`}
                        summary={`Bianca Admire is a Principal at Artemis, participating in client service and firm operations. With over a decade of client service experience and in the financial services industry, Bianca takes pride in providing prompt responses and maintaining long-term relationships with Artemis clients.`}
                    ...
                    <TeamMember
                        name="Lulu Herrick"
                        title="Associate"
                        image="/images/img_lulu.jpg"
                        bio={`Lulu Herrick is an Associate at Artemis. She supports Artemis in all facets of the business from underwriting to client service. A recent graduate with a degree in Statistics from Southern Methodist University, Lulu brings a fresh analytical perspective to her work.\n\nIn her role, she collaborates closely with carriers to ensure smooth and accurate policy placement, while also assisting with day-to-day client needs and operations. Lulu holds her General Lines Life and Health license.\n\nOutside of the office, Lulu enjoys traveling with her family and cooking with friends. She is excited to continue learning and growing within the industry.`}
                        summary={`Lulu Herrick is an Associate at Artemis. She supports Artemis in all facets of the business from underwriting to client service. A recent graduate with a degree in Statistics from Southern Methodist University, Lulu brings a fresh analytical perspective to her work.\n\nIn her role, she collaborates closely with carriers to ensure smooth and accurate policy placement, while also assisting with day-to-day client needs and operations. Lulu holds her General Lines Life and Health license.\n\nOutside of the office, Lulu enjoys traveling with her family and cooking with friends. She is excited to continue learning and growing within the industry.`}
